...
@after {
	...
	(
		...
		(
			(
				lv_main_tree_to_execute_4_0=RULE_STRING
				{
...
@after {
	...
	(
		...
		{
			$current = $this_SubtreeWrapper_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Entry rule entryRuleSubtreeWrapper
entryRuleSubtreeWrapper returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSubtreeWrapperRule()); }
	iv_ruleSubtreeWrapper=ruleSubtreeWrapper
	{ $current=$iv_ruleSubtreeWrapper.current; }
	EOF;

// Rule SubtreeWrapper
ruleSubtreeWrapper returns [EObject current=null]
@init {
	enterRule();
}
@after {
