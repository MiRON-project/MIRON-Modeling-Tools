...
public class BehaviorTreeSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == BehaviorTreePackage.eINSTANCE)
			...
			case BehaviorTreePackage.SUB_TREE_WRAPPER:
				sequence_SubtreeWrapper(context, (SubTreeWrapper) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (main_tree_to_execute=STRING imports+=Import* trees+=BehaviorTree+)
	 */
	...
	/**
	 * Contexts:
	 *     TreeNode returns SubTreeWrapper
	 *     SubtreeNode returns SubTreeWrapper
	 *     SubtreeWrapper returns SubTreeWrapper
	 *
	 * Constraint:
	 *     (behaviortree=[BehaviorTree|STRING] attributes+=Attribute*)
	 */
	protected void sequence_SubtreeWrapper(ISerializationContext context, SubTreeWrapper semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
