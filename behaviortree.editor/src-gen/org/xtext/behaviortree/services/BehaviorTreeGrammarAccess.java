...
public class BehaviorTreeGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class BTModelElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cMain_tree_to_executeSTRINGTerminalRuleCall_4_0 = (RuleCall)cMain_tree_to_executeAssignment_4.eContents().get(0);
		...
		private final Assignment cTreesAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cTreesBehaviorTreeParserRuleCall_7_0 = (RuleCall)cTreesAssignment_7.eContents().get(0);
		...
		//'<' 'root' 'main_tree_to_execute' '=' main_tree_to_execute=STRING '>' imports+=Import* trees+=BehaviorTree+ '</' 'root'
		//'>'
		...
		//STRING
		public RuleCall getMain_tree_to_executeSTRINGTerminalRuleCall_4_0() { return cMain_tree_to_executeSTRINGTerminalRuleCall_4_0; }
		...
		//trees+=BehaviorTree+
		public Assignment getTreesAssignment_7() { return cTreesAssignment_7; }
		
		//BehaviorTree
		public RuleCall getTreesBehaviorTreeParserRuleCall_7_0() { return cTreesBehaviorTreeParserRuleCall_7_0; }
	...
	public class SubtreeNodeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSubtreeWrapperParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//SubtreeWrapper
		public RuleCall getSubtreeWrapperParserRuleCall_1() { return cSubtreeWrapperParserRuleCall_1; }
	}
	public class SubtreeElements extends AbstractParserRuleElementFinder {
		...
		//{Subtree} //'<' 'Subtree' ID '=' behaviortree=[BehaviorTree|STRING] 
		//'<' SUBTREE_KEYWORD '=' behaviortree=[BehaviorTree|STRING] attributes+=Attribute* '/>'
		public Group getGroup() { return cGroup; }
	...
	public class SubtreeWrapperElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.behaviortree.BehaviorTree.SubtreeWrapper");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cSubTreeWrapperAction_0 = (Action)cGroup.eContents().get(0);
		private final Keyword cLessThanSignKeyword_1 = (Keyword)cGroup.eContents().get(1);
		...
		//SubtreeWrapper SubTreeWrapper:
		//	{SubTreeWrapper}
		//	'<' SUBTREEWRAPPER_KEYWORD '=' behaviortree=[BehaviorTree|STRING] attributes+=Attribute* '/>';
		@Override public ParserRule getRule() { return rule; }
		
		//{SubTreeWrapper} '<' SUBTREEWRAPPER_KEYWORD '=' behaviortree=[BehaviorTree|STRING] attributes+=Attribute* '/>'
		public Group getGroup() { return cGroup; }
		
		//{SubTreeWrapper}
		public Action getSubTreeWrapperAction_0() { return cSubTreeWrapperAction_0; }
	...
	private final SubtreeWrapperElements pSubtreeWrapper;
	...
	public BehaviorTreeGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pSubtreeWrapper = new SubtreeWrapperElements();
	...
	//	{SubTreeWrapper}
	//	'<' SUBTREEWRAPPER_KEYWORD '=' behaviortree=[BehaviorTree|STRING] attributes+=Attribute* '/>';
	public SubtreeWrapperElements getSubtreeWrapperAccess() {
		return pSubtreeWrapper;
	}
	
	public ParserRule getSubtreeWrapperRule() {
		return getSubtreeWrapperAccess().getRule();
	}
