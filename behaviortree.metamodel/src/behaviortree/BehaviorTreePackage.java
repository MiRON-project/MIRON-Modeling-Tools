...
public interface BehaviorTreePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int BT_MODEL__MAIN_TREE_TO_EXECUTE = 1;
	...
	/**
	 * The meta object id for the '{@link behaviortree.impl.SubTreeWrapperImpl <em>Sub Tree Wrapper</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see behaviortree.impl.SubTreeWrapperImpl
	 * @see behaviortree.impl.BehaviorTreePackageImpl#getSubTreeWrapper()
	 * @generated
	 */
	int SUB_TREE_WRAPPER = 31;
	 ...
	 * @ordered
	 */
	int SUB_TREE_WRAPPER__ATTRIBUTES = SUBTREE_NODE__ATTRIBUTES;
	 ...
	 * @ordered
	 */
	int SUB_TREE_WRAPPER__BEHAVIORTREE = SUBTREE_NODE__BEHAVIORTREE;

	/**
	 * The number of structural features of the '<em>Sub Tree Wrapper</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SUB_TREE_WRAPPER_FEATURE_COUNT = SUBTREE_NODE_FEATURE_COUNT + 0;

	/**
	 * The number of operations of the '<em>Sub Tree Wrapper</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SUB_TREE_WRAPPER_OPERATION_COUNT = SUBTREE_NODE_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the attribute '{@link behaviortree.BTModel#getMain_tree_to_execute <em>Main tree to execute</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EAttribute getBTModel_Main_tree_to_execute();
	...
	/**
	 * Returns the meta object for class '{@link behaviortree.SubTreeWrapper <em>Sub Tree Wrapper</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Sub Tree Wrapper</em>'.
	 * @see behaviortree.SubTreeWrapper
	 * @generated
	 */
	EClass getSubTreeWrapper();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute BT_MODEL__MAIN_TREE_TO_EXECUTE = eINSTANCE.getBTModel_Main_tree_to_execute();
		...
		/**
		 * The meta object literal for the '{@link behaviortree.impl.SubTreeWrapperImpl <em>Sub Tree Wrapper</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see behaviortree.impl.SubTreeWrapperImpl
		 * @see behaviortree.impl.BehaviorTreePackageImpl#getSubTreeWrapper()
		 * @generated
		 */
		EClass SUB_TREE_WRAPPER = eINSTANCE.getSubTreeWrapper();
