...
public class BehaviorTreePackageImpl extends EPackageImpl implements BehaviorTreePackage {
	 ...
	 * @generated
	 */
	private EClass subTreeWrapperEClass = null;
	...
	public static BehaviorTreePackage init() {
		...
		BehaviorTreePackageImpl theBehaviorTreePackage = registeredBehaviorTreePackage instanceof BehaviorTreePackageImpl ? (BehaviorTreePackageImpl)registeredBehaviorTreePackage : new BehaviorTreePackageImpl();
	 ...
	 */
	@Override
	public EAttribute getBTModel_Main_tree_to_execute() {
		return (EAttribute)btModelEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getSubTreeWrapper() {
		return subTreeWrapperEClass;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(btModelEClass, BT_MODEL__MAIN_TREE_TO_EXECUTE);
		...
		subTreeWrapperEClass = createEClass(SUB_TREE_WRAPPER);
	}
	...
	public void initializePackageContents() {
		...
		subTreeWrapperEClass.getESuperTypes().add(this.getSubtreeNode());
		...
		initEAttribute(getBTModel_Main_tree_to_execute(), ecorePackage.getEString(), "main_tree_to_execute", null, 0, 1, BTModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(subTreeWrapperEClass, SubTreeWrapper.class, "SubTreeWrapper", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
