...
public class BehaviorTreeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BehaviorTreePackage.SUB_TREE_WRAPPER: {
				SubTreeWrapper subTreeWrapper = (SubTreeWrapper)theEObject;
				T result = caseSubTreeWrapper(subTreeWrapper);
				if (result == null) result = caseSubtreeNode(subTreeWrapper);
				if (result == null) result = caseTreeNode(subTreeWrapper);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sub Tree Wrapper</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sub Tree Wrapper</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSubTreeWrapper(SubTreeWrapper object) {
		return null;
	}
