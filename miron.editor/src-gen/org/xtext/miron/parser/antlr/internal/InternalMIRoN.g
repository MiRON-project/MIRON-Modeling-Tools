...
entryRuleEnumLiteralAux returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEnumLiteralAuxRule()); }
	iv_ruleEnumLiteralAux=ruleEnumLiteralAux
	{ $current=$iv_ruleEnumLiteralAux.current; }
	EOF;

// Rule EnumLiteralAux
ruleEnumLiteralAux returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_BehaviorTreeLiteral_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	{
		$current = $this_VariantAssignment_0.current;
		afterParserOrEnumRuleCall();
	}
;

// Entry rule entryRuleVariantAssignment
entryRuleVariantAssignment returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getVariantAssignmentRule()); }
	iv_ruleVariantAssignment=ruleVariantAssignment
	{ $current=$iv_ruleVariantAssignment.current; }
	EOF;

// Rule VariantAssignment
ruleVariantAssignment returns [EObject current=null]
@init {
	enterRule();
}
@after {
