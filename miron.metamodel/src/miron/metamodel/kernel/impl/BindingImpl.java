 ...
 * </p>
 * <ul>
 *   <li>{@link miron.metamodel.kernel.impl.BindingImpl#getXpath <em>Xpath</em>}</li>
 *   <li>{@link miron.metamodel.kernel.impl.BindingImpl#getInsertionType <em>Insertion Type</em>}</li>
 *   <li>{@link miron.metamodel.kernel.impl.BindingImpl#getTargets <em>Targets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BindingImpl extends MinimalEObjectImpl.Container implements Binding {
	...
	public void setXpath(String newXpath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelPackage.BINDING__XPATH, oldXpath, xpath));
	}
	...
	public void setInsertionType(InsertionTypeEnum newInsertionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelPackage.BINDING__INSERTION_TYPE, oldInsertionType, insertionType));
	}
	...
	public EList<EObject> getTargets() {
		if (targets == null) {
			targets = new EObjectResolvingEList<EObject>(EObject.class, this, KernelPackage.BINDING__TARGETS);
		}
		return targets;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KernelPackage.BINDING__XPATH:
				return getXpath();
			case KernelPackage.BINDING__INSERTION_TYPE:
				return getInsertionType();
			case KernelPackage.BINDING__TARGETS:
				return getTargets();
		}
