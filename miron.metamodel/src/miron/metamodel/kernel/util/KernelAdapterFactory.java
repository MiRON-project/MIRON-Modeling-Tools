...
public class KernelAdapterFactory extends AdapterFactoryImpl {
	...
	protected KernelSwitch<Adapter> modelSwitch =
		new KernelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseVariantAssignment(VariantAssignment object) {
				return createVariantAssignmentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link miron.metamodel.kernel.RuleAction <em>Rule Action</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link miron.metamodel.kernel.VariantAssignment <em>Variant Assignment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVariantAssignmentAdapter() {
		return null;
	}
