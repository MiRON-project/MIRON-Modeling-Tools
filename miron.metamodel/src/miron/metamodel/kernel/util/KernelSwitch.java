...
public class KernelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case KernelPackage.RULE_ACTION: {
			...
			case KernelPackage.VARIANT_ASSIGNMENT: {
				VariantAssignment variantAssignment = (VariantAssignment)theEObject;
				T result = caseVariantAssignment(variantAssignment);
				if (result == null) result = caseRuleAction(variantAssignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Variant Assignment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Variant Assignment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVariantAssignment(VariantAssignment object) {
		return null;
	}
